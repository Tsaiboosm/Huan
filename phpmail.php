<?php
	...
	require 'PHPMailer/lib/function.php';
	session_start();
//如果输入了邮箱和验证码
if($_POST['email']!=null&&$_POST['checkCode']!=null){
    ...
    try {
        ...
        $mail->setFrom('3399604033@qq.com', '华为商城');  //发件人
        $mail->addAddress($email, '客户');  // 收件人
        //$mail->addAddress('ellen@example.com');  // 可添加多个收件人
        $mail->addReplyTo('3399604033@qq.com', '华为商城'); //回复的时候回复给哪个邮箱 建议和发件人一致
...
//      $mail->addAttachment($com[1]);         // 添加附件
        ...
        echo '邮箱格式不合法: ', $mail->ErrorInfo."<br>";
    }
	require 'forgetPassword_html.php';
}
//什么都没填
